...
- framework parent: `com.lumispring.framework:framework-starter-parent:4.1.1.0`
- framework BOM: `com.lumispring.framework:framework-dependencies:4.1.1.0`
- Starter group: `com.lumispring.framework`
- Spring Boot: `4.1.1`
- Kotlin: `2.4.20`
- Java: `21`

Do not mix groups in one POM. Verify the coordinates exposed by the actual Maven registry or checked-out template version.
...
```xml
<properties>
    <framework.version>4.1.1.0</framework.version>
</properties>
