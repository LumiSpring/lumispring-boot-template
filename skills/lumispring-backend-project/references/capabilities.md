...
The Starter provides Spring MVC/WebFlux, AOP, validation, springdoc OpenAPI UI, MySQL support, global exception handling, request trace IDs, SSE, and automatic response wrapping. Controller methods can return domain data directly:
...
springdoc Swagger UI is normally available at `/swagger-ui.html` after the web application starts.
